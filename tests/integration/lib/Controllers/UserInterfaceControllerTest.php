...
class UserInterfaceControllerTest extends TestCase
{
    ...
    public function generateRealmGroupBys()
    {
        ...
        $statistics = array(
            ...
            'eligible_wait_time_per_job' => 'Wait Hours by Eligible Time: Per Job',
            'eligible_wait_time' => 'Wait Hours by Eligible Time: Total',
            'wait_time_per_job' => 'Wait Hours by Submit Time: Per Job',
            'wait_time' => 'Wait Hours by Submit Time: Total',
